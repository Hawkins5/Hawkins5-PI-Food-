...
function validate(input) {
    ...
    if (!input.summary) errors.summary = 'Please add comments about your dish';
    ...
    if (!input.steps.length) errors.steps = 'Please share details from your recipe';
    if (!input.dietTypes.length) errors.dietTypes = 'You must select one diet type';
    return errors;
};
