...
export default function Home() {
    ...
    return(
        <div className="home">
            <h1 className="initialMsg">Let's cook it!</h1>
            <div>
                <button className="refreshButton" onClick={handleClick}>Refresh dishes</button>
                <Link to="/recipe">
                        ...
                        <div className="eachRecipe" key={prevId++}>
                            <Link className="linkRecetas" to={`home/${e.id}`}>
                                <Recipe
                                    image={e.image ? 
                                        e.image :
                                        'https://images.unsplash.com/photo-1556911220-bff31c812dba?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8a2l0Y2hlbiUyMGJhY2tncm91bmR8ZW58MHx8MHx8&w=1000&q=80'}
                                    name={e.name}                             
